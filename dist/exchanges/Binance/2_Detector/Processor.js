export const Processor = new class {
    ...
    generateTree = ({ currenciesTradesInfo, firstTarget, target, targetBalance, steps, prevSymbol = null }) => {
        if (steps !== 0) {
    ...
    calculateTheoreticalQuantity({ side, filters, balance, price, takerCommission, baseAssetPrecision, quoteAssetPrecision, baseCommissionPrecision, quoteCommissionPrecision }) {
        switch (side) {
            case 'BUY': {
